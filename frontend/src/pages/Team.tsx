...
export default () => {
    ...
    return (
        <div className=' min-h-[70vh] bg-slate-100 py-5'>
            ...
            {team.length > show &&
                <div className="blurry-deck h-60 overflow-hidden place-items-center relative grid grid-rows autogrid-cols-2 lg:grid-cols-3 xl:grid-cols-4  mx-0 my-8  gap-2">
                    {team.map((a: any, index: number) => {
                        if (index <= show) {
                            return ''
                        }
